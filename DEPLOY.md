...
1. Connect the same GitHub repo to Cloudflare Pages / Netlify (a few clicks).
2. Re-point thelast24.in's DNS to them instead of GitHub.
3. No code changes needed — they strip `.html` automatically.
